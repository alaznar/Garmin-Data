...
def loadData():
    ...
    folderLocation = 'C:/Users/alexa/OneDrive/Documents/Code/Python/Projects/Garmin Data/data/DI_CONNECT/DI-Connect-Wellness/sleepData/*.json'
...
def saveRawSleepEntries(sleepData):
    ...
    sleepData.to_csv('C:/Users/alexa/OneDrive/Documents/Code/Python/Projects/Garmin Data/data/DI_CONNECT/DI-Connect-Wellness/sleepData/GarminSleepData.csv', index=False)
...
def saveConfirmedSleepEntries(sleepData):
    ...
    sleepData.to_csv('C:/Users/alexa/OneDrive/Documents/Code/Python/Projects/Garmin Data/data/DI_CONNECT/DI-Connect-Wellness/sleepData/ConfirmedSleepDataEntries.csv', index=False)
